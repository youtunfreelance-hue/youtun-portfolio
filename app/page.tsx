...
export default function Page() {
  ...
  const handleDispatch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Automatically generates the email with the project details
  ...
  return (
    <main className="min-h-screen p-6 md:p-24 max-w-[1400px] mx-auto selection:bg-accent/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-end mb-40">
        ...
        <div className="lg:col-span-4 glass-panel p-12 group">
          ...
          <div className="flex justify-between font-mono text-[10px] text-slate-600">
            ...
            <span className="text-accent font-bold">6.7% ACTIVE</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-40">
        <div className="glass-panel p-16 group">
          ...
          <p className="text-[10px] text-accent font-mono mb-8 tracking-widest uppercase">Inventory Scaling</p>
        ...
        <div className="glass-panel p-16 bg-white/[0.01]">
          <h3 className="text-4xl font-black italic mb-2 group-hover:text-accent transition-colors">DHA_ELITE</h3>
          <p className="text-[10px] text-accent font-mono mb-8 tracking-widest uppercase">Corp Deployment</p>
          <p className="text-slate-500 mb-12 text-sm leading-relaxed max-w-xs font-medium">Ultra-premium corporate landing pages with high-end motion design.</p>
      ...
      <section className="max-w-4xl mx-auto text-center">
        ...
        <form 
          ...
          className="glass-panel p-12 md:p-20 text-left relative overflow-hidden"
        >
          <div className="grid grid-cols-1 gap-16 relative z-10">
            <div className="flex flex-col gap-3">
              ...
              <input 
                ...
                className="luxury-input uppercase text-sm font-bold placeholder:text-slate-800" 
              />
            </div>
            ...
            <button 
              type="submit" 
              className="w-full py-10 bg-accent text-slate-950 font-black uppercase tracking-[0.6em] text-xs hover:tracking-[0.8em] transition-all duration-700 active:scale-95 shadow-[0_20px_40px_rgba(0,242,255,0.2)]"
            >
              Dispatch Proposal
            </button>
          </div>
